...
class Order extends Eloquent
{
    ...
    protected $fillable = array('customers_id','customers_name','customers_phone','customers_email','customers_address', 'order_create_time', 'order_status', 'order_price_total', 'customer_note');
