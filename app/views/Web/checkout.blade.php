...
<head>
    <link rel="shortcut icon" href="//hstatic.net/609/1000111609/1000206992/favicon.png?v=227" type="image/png" />
    <title>
        Vietherb - Thanh toán đơn hàng
    </title>


    <meta name="description" content="Vietherb - Thanh to&#225;n đơn h&#224;ng" />

    <link href='//hstatic.net/0/0/global/checkouts.css?v=1.1' rel='stylesheet' type='text/css'  media='all'  />
    <link href='//hstatic.net/609/1000111609/1000206992/check_out.css?v=227' rel='stylesheet' type='text/css'  media='all'  />
...
<button class="order-summary-toggle order-summary-toggle-hide">
    <div class="wrap">
        <div class="order-summary-toggle-inner">
            ...
            <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="57500000">
                <span class="total-recap-final-price">575,000₫</span>
            </div>
        </div>
    </div>
</button>
                    ...
                    <div class="order-summary-sections">
                        <div class="order-summary-section order-summary-section-product-list" data-order-summary-section="line-items">
                            <table class="product-table">
                                ...
                                <tr class="product" data-product-id="1003963377" data-variant-id="1009983914">
                                    <td class="product-image">
                                        <div class="product-thumbnail">
                                            <div class="product-thumbnail-wrapper">
                                                <img class="product-thumbnail-image" alt="Combo rượu Mơ Lông + Đinh Lăng" src="//hstatic.net/609/1000111609/1/2017/1-11/e811978672e849a1ab6d277c744dac6f_small.jpg" />
                                            </div>
                                            <span class="product-thumbnail-quantity" aria-hidden="true">1</span>
                                        </div>
                                    </td>
                                    <td class="product-description">
                                        <span class="product-description-name order-summary-emphasis">Combo rượu Mơ Lông + Đinh Lăng</span>

                                        <span class="product-description-variant order-summary-small-text">
																		Mơ Lông 750ml + Đinh Lăng 650ml
																	</span>
                                ...
                                <tr class="product" data-product-id="1003914640" data-variant-id="1009874516">
                                    <td class="product-image">
                                        <div class="product-thumbnail">
                                            <div class="product-thumbnail-wrapper">
                                                <img class="product-thumbnail-image" alt="Combo tắm + rửa mặt tân niên" src="//product.hstatic.net/1000111609/product/img_3804_small.jpg" />
                                            </div>
                                            <span class="product-thumbnail-quantity" aria-hidden="true">1</span>
                                        </div>
                                    </td>
                                    <td class="product-description">
                                        <span class="product-description-name order-summary-emphasis">Combo tắm + rửa mặt tân niên</span>
                                    ...
                                    <td class="product-quantity visually-hidden">1</td>
                                    <td class="product-price">
                                        <span class="order-summary-emphasis">120,000₫</span>
                                    </td>
                                </tr>
                            ...
                            <table class="total-line-table">
                                ...
                                <tr class="total-line total-line-subtotal">
                                    ...
                                    <td class="total-line-price">
															<span class="order-summary-emphasis" data-checkout-subtotal-price-target="57500000">
																575,000₫
															</span>
                                    </td>
                                </tr>
                                ...
                                <tr class="total-line">
                                    ...
                                    <td class="total-line-name payment-due">
                                        ...
                                        <span class="payment-due-price" data-checkout-payment-due-target="57500000">
																575,000₫
															</span>
                                    </td>
                                </tr>
            ...
            <div class="main-header">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="http://vietherb.vn/cart">Giỏ hàng</a>
                    </li>
            ...
            <div class="main-content">
                ...
                <div class="step">
                        ...
                        <div class="section">
                            ...
                            <div class="section-content section-customer-information no-mb">
                                ...
                                <p class="section-content-text">
                                    Bạn đã có tài khoản?
                                    <a href="http://vietherb.vn/account/login?urlredirect=http%3a%2f%2fvietherb.vn%2fcheckouts%2f4139c72ef9ff47e99b78bf42f7095265%3fstep%3d1">Đăng nhập</a>
                                </p>
                    ...
                    <div class="step-footer">
                        ...
                        <a class="step-footer-previous-link" href="http://vietherb.vn/cart">
